    ...
    <main className="mx-auto max-w-5xl px-6 py-8 sm:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.3fr_0.9fr]">
        <section className="rounded-2xl border border-black/5 bg-white/85 p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900/85">
          <div className="h-[340px] animate-pulse rounded-xl bg-zinc-200 dark:bg-zinc-800" />
          ...
          <div className="mt-6 h-28 animate-pulse rounded-xl bg-zinc-200 dark:bg-zinc-800" />
        </section>

        <aside className="rounded-2xl border border-black/5 bg-white/85 p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900/85">
